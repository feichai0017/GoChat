...
const file_helloworld_proto_rawDesc = "" +
	"\n" +
	"\x10helloworld.proto\x12\fhelloservice\"\"\n" +
	...
	"\aGreeter\x12B\n" +
	"\bSayHello\x12\x1a.helloservice.HelloRequest\x1a\x18.helloservice.HelloReply\"\x00B\x11Z\x0f./;helloserviceb\x06proto3"
...
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: helloservice.Greeter.SayHello:input_type -> helloservice.HelloRequest
	1, // 1: helloservice.Greeter.SayHello:output_type -> helloservice.HelloReply
